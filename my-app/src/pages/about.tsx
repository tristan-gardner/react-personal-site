  ...
  return (
    <Box style={{
        ...
        <Box style={{
            ...
            I later moved on to work as a fullstack engineer at Flowcode and most recently, 
            I have been a senior engineer at Roots Automation. I have a strong background in software development with an emphasis on python, and a desire for new challenges.</p>
        </Box>
        <Box style={{
            display: 'flex',
            flexDirection: 'column',
